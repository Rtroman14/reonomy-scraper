...
const REONOMY_URL = "https://app.reonomy.com/!/search/c9719ba2-a58c-4aeb-a3de-fd44f73c705e";
...
(async () => {
    ...
    try {
        ...
        if (headers && body) {
            ...
            // }
            const propertyIDs = await Reonomy.propertyIDs(headers, body, "0");
            console.log(propertyIDs);
            writeJson(propertyIDs, "propertyIDs");
        }
